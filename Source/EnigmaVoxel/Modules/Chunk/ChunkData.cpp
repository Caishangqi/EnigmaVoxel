...
/// @param ChunkData 
void AppendBoxForBlock(FDynamicMesh3& Mesh, const FBlock& Block, FChunkData& ChunkData)
{
...
/// @param Block 
/// @param ChunkData 
void AppendBoxForBlock(UEnigmaWorld* World, FDynamicMesh3& Mesh, const FBlock& Block, FChunkData& ChunkData)
{
	const FIntVector blockPos = Block.Coordinates;
